...
- Keep authentication state out of the domain. Password hashes, tokens, credentials, email confirmation and two factor settings are infrastructure persistence models behind application abstractions; an aggregate never carries a hash or a login switch.
